...
#### A [formal paper](https://github.com/jwangjie/An-Intuitive-Tutorial-to-Gaussian-Processes-Regression/blob/master/latex/arXiv/An_Intuitive_Tutorial_to_Gaussian_Processes_Regression.pdf) of the notebook:
```
